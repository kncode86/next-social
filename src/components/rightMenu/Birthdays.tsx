        ...
        <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Image 
                        src="https://images.pexels.com/photos/29292655/pexels-photo-29292655/free-photo-of-elenk-oceanhullamok-csapodnak-ossze-lanzarote-partjain.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                        alt=""
                        width={40}
                        height={40}
